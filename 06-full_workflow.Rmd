...
```{r Targets: prepare, echo = FALSE, comment = ''}
# Targets: prepare
id_col <- 'id'
datetime_col <- 't_'
x_col <- 'x_'
...
```{r sl/ta distributions, echo=FALSE}
...
targets_model_lc[[1]]$command$expr
...
targets_model_forest[[1]]$command$expr
...
```{eq modified speed calcualtion written example}
# i don't know if this is how I do this, as usual, i'm making stuff up
...
```{r example mean estimated speed}
