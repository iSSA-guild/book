...
Here, all you will have to do is at the beginning of the work flow is fill in 
...
same outcome (see CITE for proof). But this is all the mathematical details.
...
$\text{mean estimated speed} = (shape + log_sl_beta + log_sl_intx_beta*mean(what interacted with))*scale$
