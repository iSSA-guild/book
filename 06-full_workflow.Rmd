...
## Preface
This is an example of me "talking" the reader through conducting an iSSA on the
fisher data that is set up in our [targets
workflow](https://github.com/iSSA-guild/targets-issa).
