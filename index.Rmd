...
# Introduction
This guide is a team effort synsthesizing past experiences, best practices, and
leading resources. Given how difficult it is to just start an iSSA and all the
choices that need to be made, we wanted to create a workbook to be an
approachable gateway to the world of iSSAs. We wanted to bring everything
together we have done to help others.
